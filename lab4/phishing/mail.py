...
smtp_port = 587
sender_email = "hdksp[@gmail.com"  # Replace with your email address
sender_password = "hskdpo"     # Replace with your email password or app-specific password
receiver_email = "hdjslo@gmail.com"  # Replace with the recipient's email
